  ...
  return ( 
    ...
    >
      ...
      >
        ...
        <div
          className="allevent-buttn"
          id="list"
          style={{ margin: "10vh 2vw 2vh -37vw" }}
        >
          <button
            class="allevent-btn"
            onClick={() => {
        ...
        <div className="all-event_list" id="style-2">
          {events.map((event, index) => (
            <div className="all-event-padd" style={{ padding: "20px" }}>
              ...
              >
                {event.imageUrl ? (
                  <img
                    className="allevent-card-image"
                    src={event.imageUrl}
                    alt="Event"
                  ></img>
                ) : (
                  <img
                    className="allevent-card-image-firebase"
