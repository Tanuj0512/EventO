...
import { deVerify, eventVerify } from "../utils/fireStoreUtils.js";
const View_event = () => {
            ...
            {sessionStorage.getItem("type") === "admin" ? (
              ...
              <div className="Socials">
                ...
                <div className="Share-btn">
                  <ShareBtn shareId={window.location.href} />
                </div>
              </div>
            )}
